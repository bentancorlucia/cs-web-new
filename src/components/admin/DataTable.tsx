                ...
                <th className="w-14 px-6 py-4">
                  <button
                    ...
                    className={cn(
                      ...
                      allSelected
                        ? "bg-amarillo border-amarillo shadow-sm shadow-amarillo/30"
                        : "bg-white/10 border-white/40 hover:border-white/60 hover:bg-white/20"
                    )}
                  >
                    {allSelected && (
                      <svg className="w-3 h-3 text-bordo-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={3}>
                ...
                <tr key={i} className="animate-pulse">
                  {(onSelectRow || onSelectAll) && (
                    <td className="px-6 py-5">
                      <div className="w-5 h-5 bg-slate-100 rounded-md border-2 border-slate-200" />
                    </td>
                  )}
                  {columns.map((column) => (
                      ...
                      <td className="px-6 py-5" onClick={(e) => e.stopPropagation()}>
                        <button
                          ...
                          className={cn(
                            ...
                            "border-2 transition-all duration-200",
                            isSelected
                              ? "bg-bordo border-bordo shadow-sm shadow-bordo/30"
                              : "bg-white border-gray-300 hover:border-bordo/50 hover:bg-bordo/5"
                          )}
                        >
                          {isSelected && (
