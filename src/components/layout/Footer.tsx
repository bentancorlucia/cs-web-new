...
const footerLinks = {
  ...
  deportes: {
    ...
    links: [
      ...
      { label: "Natación", href: "/deportes/natacion" },
  ...
  contacto: {
    ...
    links: [
      ...
      { label: "Teléfono", href: "tel:+59824876696" },
      { label: "WhatsApp", href: "https://wa.me/59894622696" },
      { label: "Email", href: "mailto:seminario@seminariouruguay.com" },
    ],
  },
};
...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://facebook.com/clubseminario",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/clubseminario",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/clubseminario",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center md:text-left">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/90">
                  Lun - Vie: 8:00 - 22:00 | Sáb: 9:00 - 20:00
                </p>
              </div>
            </div>
          </div>
