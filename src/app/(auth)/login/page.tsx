  ...
  return (
    <Card variant="elevated" padding="lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        {error && (
          <div className="flex items-start gap-3 p-4 rounded-xl bg-red-50/80 border border-red-200/60 text-red-700 text-sm animate-in fade-in slide-in-from-top-2 duration-200">
            <svg
